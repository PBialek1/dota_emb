...
SET position        = :position,
    ...
    mana_pct        = :mana_pct,
    dist_to_ally_0  = :dist_to_ally_0,
    dist_to_ally_1  = :dist_to_ally_1,
    dist_to_ally_2  = :dist_to_ally_2,
    dist_to_ally_3  = :dist_to_ally_3,
    dist_to_enemy_0 = :dist_to_enemy_0,
    dist_to_enemy_1 = :dist_to_enemy_1,
    dist_to_enemy_2 = :dist_to_enemy_2,
    dist_to_enemy_3 = :dist_to_enemy_3,
    dist_to_enemy_4 = :dist_to_enemy_4,
    dist_to_tower_0 = :dist_to_tower_0,
    dist_to_tower_1 = :dist_to_tower_1,
    dist_to_tower_2 = :dist_to_tower_2,
    dist_to_tower_3 = :dist_to_tower_3,
    dist_to_tower_4 = :dist_to_tower_4,
    dist_to_tower_5 = :dist_to_tower_5,
    kills           = :kills,
    deaths          = :deaths,
    assists         = :assists,
